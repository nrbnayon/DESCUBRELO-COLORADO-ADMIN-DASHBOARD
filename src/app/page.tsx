      ...
      <nav className="relative z-20 p-6">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center space-x-2">
            <div className="w-16 h-12 bg-gradient-to-r rounded-lg flex items-center justify-center bg-primary p-1.5">
            ...
            <span className="text-xl font-bold text-white">Colorado</span>
          </div>
          <Link
            href="/login"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mt-6 pt-6 border-t border-white/10">
            <p className="text-gray-400 text-sm">
              © 2025 Colorado. All rights reserved. Built for administrators who
              demand excellence.
            </p>
          </div>
        </div>
